        ...
        <div class="col-12">
            <div class="card mb-3">
                <div class="card-body px-0 pt-0 pb-2">
                    <form action="{{ route('tvs.update', $tv->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="wartawan_id" name="wartawan_id">
                                @foreach($wartawans as $wartawan)
                                    <option value="{{ $wartawan->id }}" @if($tv->wartawan_id == $wartawan->id) selected @endif>{{ $wartawan->username }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mb-3">
                            <label for="nama_media" class="form-label">Nama Media</label>
                            <input type="text" name="nama_media" class="form-control" id="nama_media" aria-describedby="emailHelp" value="{{ $tv->nama_media }}">
                        </div>          
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Jenis Media</label>
                            <input type="text" name="jenis_media" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $tv->jenis_media }}">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Jenis Pesanan</label>
                            <input type="text" name="jenis_pesanan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $tv->jenis_pesanan }}">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Jumlah Pesanan</label>
                            <input type="text" name="jumlah_pesanan" class="form-control" id="jumlah_pesanan" aria-describedby="emailHelp" value="{{ $tv->jumlah_pesanan }}">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Satuan</label>
                            <input type="text" name="satuan" class="form-control" id="satuan" aria-describedby="emailHelp" value="{{ $tv->satuan }}">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Harga</label>
                            <input type="text" name="harga" class="form-control" id="harga" aria-describedby="emailHelp" value="{{ $tv->harga }}">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Total Transfer</label>
                            <input type="text" name="total_transfer" class="form-control" id="total_transfer" aria-describedby="emailHelp" value="{{ $tv->total_transfer }}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Jumlah</label>
                            <input type="text" name="jumlah" class="form-control" id="jumlah" aria-describedby="emailHelp" value="{{ $tv->jumlah }}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Pajak (%)</label>
                            <input type="text" name="pajak" class="form-control" id="pajak" aria-describedby="emailHelp" value="{{ $tv->pajak }}">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Tanggal</label>
                            <input type="date" name="bulan" class="form-control" id="bulan" aria-describedby="emailHelp" value="{{ $tv->bulan }}">
                        </div>
                        <div class="form-group">
                            <label for="lampiran">Lampiran:</label>
                            <input type="file" class="form-control-file" name="lampiran" id="lampiran"aria-describedby="emailHelp" value="{{ $tv->lampiran }}">
                        </div>
